...
var bullets = 200;
  ...
  */
  ...
  var lunarRadar = {
    ...
    long: 72.33836,
    lat: -50.61970,
    approachSpeed: 250, // "ft per minute"
  }
  ...
  */
  ...
  if ((lunarRadar.isEnabled === true) && (lunarRadar.long !== null) && (lunarRadar.lat !== null)) {
    console.log("\u{1F91F} looking good " + name + " we are making our descent, now entering approach speed");
  ...
  switch (true) {
    case (lunarRadar.isEnabled === true && lunarRadar.long !== null) && (lunarRadar.lat !== null):
      console.log("\u{1F91F} looking good " + name + " we are making our descent, now entering approach speed");
      ...
      switch (true) {
        ...
        default: console.log('Please enter an approach speed');
      }
      break;

    default: console.log("\u{1F9F1}\u{1F9F1}\u{1F9F1}\u{1F9F1} " + name + " you went down like a ton of bricks, the wrecked remains of the lunar lander can still be seen from earth twinkling in the distance.");
  }
  ...
  */
  ...
  var pluto = [ "PLUTO",
    [
      "Pluto is sadly not a planet. Pluto is the largest known dwarf planet in the Solar System, discovered in 1930. ",
      "-229°C",
  ...
  var saturn = [ "SATURN",
    [
      ...
      "-175C (-285F)",
      "The mass of Saturn is about 95 times greater than our planet."
    ],
  ];
